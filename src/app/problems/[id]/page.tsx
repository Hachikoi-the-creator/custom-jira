    ...
    <AppLayout>
      <div className="max-w-3xl">
        ...
        <div className="space-y-5">
          ...
          <div className="card"><h2 className="section-title mb-3">Descripción del problema</h2><p className="text-foreground/90 text-sm leading-relaxed whitespace-pre-wrap">{problem.description}</p></div>
          <div className="card border-teal-200 bg-teal-50/30"><h2 className="section-title text-teal-700 mb-3">✓ Solución aplicada</h2><p className="text-foreground/90 text-sm leading-relaxed whitespace-pre-wrap">{problem.solution}</p></div>
        </div>
      </div>
    </AppLayout>
  )
